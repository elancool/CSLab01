...
#CHANGE BELOW
profile_picture = "Images/profile-min.jpg"
...
experience_data = {
    "Team Leader at Chick-Fil-A": (
        ...
        ["Images/Professional-min.jpg", "Images/Me_n_Twin-min.jpg"]
    ),
...
leadership_data = {
    "Team Leader at Chick-Fil-A": (["- Provided 3 years of leadership and guidance to our team"],"Images/Me_n_Trevor-min.jpg"),
...
car_timeline_data = [
    {
        ...
        'image': 'Images/Vette-min.jpg'
    },
    {
        'date': 'December 2022',
        'action': 'Wrecked',
        'car': '1990 Chevrolet Corvette',
        'details': 'Learned a lesson about driving the hard way. Put my first car into a ditch less than a mile from home.',  
        'image': 'Images/Vettewreck-min.jpg'
    },
    {
        'date': 'October 2023',
        'action': 'Bought',
        ...
        'image': 'Images/Camaro-min.jpg'
    },
    {
        'date': 'August 2024',
        'action': 'Bought',
        'car': '2007 Mercedes Benz E550',
        'details': 'Decided to buy a responsible adult car for commuting back and forth to school.',
        'image': 'Images/Mercedes-min.jpg'
    },
    {
        'date': 'March 2025',
        'action': 'Sold',
    ...
    },
    {
        ...
        'details': 'My current vehicle, and one I have wanted for a long time. Also my first manual car!', 
        'image': 'Images/Firebird-min.jpg'
    }
]
hobbies_data = {
...
motorcycle_locations = [
        ...
        "name": "The Pocket",
        "date": "April 2025",
        "image": "Images/pocket_ride-min.jpg", 
    ...
    },
    {
        ...
        "date": "May 2025",
        "image": "Images/Johnsmountain-min.jpg",
    ...
    },
    {
        "name": "Blood Mountain",
        "date": "September 2025", 
        "image": "Images/bloodmountain-min.jpg",
