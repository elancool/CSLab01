...
# Car Timeline
        ...
        with st.expander("🎯 Shooting with Friends"):
            ...
            with col2:
                try:
                    st.image("Images/3Migos.jpg", width=200, caption="Doing some casual shooting with the boys")
                except:
                    st.write("📷 Image not found")
        ...
        with st.expander("🔧 Building & Customizing Firearms"):
            ...
            with col1:
                try:
                    st.image("Images/buildingaglock.jpg", width=200, caption="Assembling a gen3 parts kit in a new 3D printed frame after I warped the first one.")
                except:
                    st.write("📷 Image not found")
            with col2:
                st.write("""
        ...
        st.markdown("#### 🛣️ My Georgia Mountain Riding Journey")
        ...
        st.success("🏁 More riding adventures to come!")
